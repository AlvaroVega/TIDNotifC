...
//       }
   ...
   /**************************************************************************/
    CosNotifyChannelAdmin::ProxyPushSupplier_ptr proxyPushSupplier;
    
    proxyPushSupplier = CosNotifyChannelAdmin::ProxyPushSupplier::_narrow(proxySupplier);
    ...
    CosNotifyComm::PushConsumer_ptr my_pushConsumer = CosNotifyComm::PushConsumer::_narrow(obj_consumer);


    /***********************************************************************/
    /*                CONECTAMOS EL PUSHSUPPLIER Y EL PUSHCONSUMER         */
    /***********************************************************************/
    proxyPushSupplier->connect_any_push_consumer(my_pushConsumer);

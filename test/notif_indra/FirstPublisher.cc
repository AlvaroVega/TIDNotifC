...
int main(int argc, char *argv[]){
  ...
  argv_orb[4]=strdup("first_supplier.log");
  argv_orb[5]=strdup("-ORB_max_blocked_time");
  argv_orb[6]=strdup("1500000");
  argv_orb[7]=strdup("-ORB_ssl_private_key");
  argv_orb[8]=strdup("publisher_key.pem");    
  argv_orb[9]=strdup("-ORB_ssl_certificate");
  argv_orb[10]=strdup("publisher_cert.pem");    
//   argv_orb[5]=strdup("-ORB_iiop_orb_port");
//   argv_orb[6]=strdup("3133");

...
void my_push_consumer::disconnect_structured_push_consumer(){
    _supplier->disconnect_structured_push_supplier();
    _supplier = NULL;
...
/*
    ...
    void my_push_consumer::push_structured_event(const CosNotification::StructuredEvent& event){
      //const DynamicAny::DynAny_ptr _dany = TestUtils::structured_event_to_dynany(ev);
      cerr<<"Llego el evento al consumidor"<<endl;

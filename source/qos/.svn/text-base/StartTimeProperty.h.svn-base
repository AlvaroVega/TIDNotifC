...
#ifndef _TIDNOTIF_QOS_STARTTIMEPROPERTY_H_
#define _TIDNOTIF_QOS_STARTTIMEPROPERTY_H_
...
class StartTimeProperty: public QoSProperty{

private:
  
  Messaging::RequestStartTimePolicy_var policy;
...
protected: 
  ...
  StartTimeProperty(const CosNotification::Property& property, 

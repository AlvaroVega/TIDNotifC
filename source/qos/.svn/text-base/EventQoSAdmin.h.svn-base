...
#ifndef _TIDNOTIF_QOS_EVENTQOSADMIN_H_
#define _TIDNOTIF_QOS_EVENTQOSADMIN_H_
...
class EventQoSAdmin : public virtual QoSAdmin{
...
public:
   ...
   * @param orb
   */
  EventQoSAdmin(CORBA::ORB_ptr orb);
...
protected:
  ...
  CosNotification::PropertyError_ptr 
  validate(ConnectionReliabilityProperty& property);
  
  CosNotification::PropertyError_ptr 
  validate(QueueOrderProperty& property);

  CosNotification::PropertyError_ptr 
  validate(StartTimeSupportedProperty& property);

  CosNotification::PropertyError_ptr 
  validate(StopTimeSupportedProperty& property);

...
#ifndef _TIDNOTIF_QOS_TIMEOUTPROPERTY_H_
#define _TIDNOTIF_QOS_TIMEOUTPROPERTY_H_
...
class TimeoutProperty : public QoSProperty{
...
protected:
  ...
  TimeoutProperty(const CosNotification::Property& property, 

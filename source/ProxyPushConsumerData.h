// -*- c++ -*-
/*
 *  File name: ProxyPushConsumerData.h
...
#ifndef _INTERNAL_PROXY_PUSH_CONSUMER_DATA_H_
#define _INTERNAL_PROXY_PUSH_CONSUMER_DATA_H_
...
public:
  ...
  InternalSupplierAdmin_var _supplier_admin; 

  CosEventComm::PushSupplier_var _push_supplier;

...
#ifndef _TIDUTIL_UNION_DEFAULT_SWITCH_PATH_H
#define _TIDUTIL_UNION_DEFAULT_SWITCH_PATH_H
 ...
 * struct field name.
 */
class UnionDefaultSwitchPath : public SequencePath
{
  ...
  public:
     ...
     */
    UnionDefaultSwitchPath(SequencePath * next_step);
